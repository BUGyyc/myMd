...
{
    Dictionary<int, int> levelDic = null;
    Dictionary<int, TreeNode> parentDic = null;
    public bool IsCousins(TreeNode root, int x, int y)
    {
        levelDic = new Dictionary<int, int>();
        parentDic = new Dictionary<int, TreeNode>();
        dfs(root, null);
        TreeNode a = parentDic[x];
        TreeNode b = parentDic[y];
        if (a == null && b == null) return false;
        return (levelDic[x] == levelDic[y]) && (a != b);
    }
